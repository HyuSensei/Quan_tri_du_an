...
namespace Do_An_PhanTienHuy_NguyenHuuToan
{
    public partial class fr_khachhang : Form
    {
        ...
        private void KhachHang_Load(object sender, EventArgs e)
        {
            ...
            this.khachHangTableAdapter.Fill(this._DoAn_NetDataSet1.KhachHang);
            dis_khachhang();
        ...
        private void gv_khachhang_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
           /* int rows_id = e.RowIndex;
            ...
            row = gv_khachhang.Rows[e.RowIndex];
            txt_makhachhang.Text = Convert.ToString(row.Cells[0].Value);
            txt_tenkhachhang.Text = Convert.ToString(row.Cells[0].Value);
            txt_sodienthoai.Text = Convert.ToString(row.Cells[0].Value);
            txt_diachi.Text = Convert.ToString(row.Cells[0].Value);
